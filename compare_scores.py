...
width = 0.2
colors = ['#000000', '#FF4500', '#FCD603', '#B4B6B8']  # Blue, Orange, Green, Red


rects1 = ax.bar(x - width * 2, humans_totals, width, label='Humans', color = colors[0])
rects2 = ax.bar(x - width, gpt4_4_totals, width, label='GPT-4 (04/2024)', color = colors[1])
rects3 = ax.bar(x, gpt4_totals, width, label='GPT-4', color = colors[2])
rects4 = ax.bar(x + width, llama2_totals, width, label='Llama2', color = colors[3])
...
combined_data = np.vstack([humans_totals, gpt4_totals, gpt4_4_totals, llama2_totals]).T
...
normalized_gpt4_4 = normalized_data[:, 2]
normalized_llama2 = normalized_data[:, 3]
...
normalized_ax.plot(labels, normalized_gpt4, label='GPT-4 (Normalized)', marker='s', color = colors[1])
normalized_ax.plot(labels, normalized_gpt4_4, label='GPT-4 04/2024 (Normalized)', marker='s', color = colors[2])
normalized_ax.plot(labels, normalized_llama2, label='Llama2 (Normalized)', marker='^', color = colors[3])
...
# Define bar widths and positions
width = 0.2
rects1 = ax.bar(x - width * 2, normalized_humans, width, label='Humans', color = colors[0])
rects2 = ax.bar(x - width, normalized_gpt4, width, label='GPT-4 (04/2024)', color = colors[1])
rects3 = ax.bar(x, normalized_gpt4_4, width, label='GPT-4', color = colors[2])
rects4 = ax.bar(x + width, normalized_llama2, width, label='Llama2', color = colors[3])
