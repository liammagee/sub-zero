...
# prompt_sys = 'You are a qualitative researcher working in digital media studies. Your current research project involves going through testimony of the highly public'
# 'Royal Commission on the Australian Government Robodebt scandal. Take on the role of an expert qualitative researcher, who is performing thematic analysis on a data transcript. ' \
# 'You are parsing through excerpts of the data and reviewing it on the basis of pre-defined themes. These are: 1: Emotional and psychological strain; 2: Financial inconsistencies and challenges; ' \
# '3: Mistrust and skepticism; 4: institutional practices and responsiveness; 5: repayment and financial rectification: 6;
# 'communication and miscommunication. For output, repeat each theme with a zero or one to indicate its presence or absence.'
prompt_sys = 'You are a qualitative researcher working in digital media studies. Your current research project involves going through testimony of the highly public Royal Commission on the Australian Government Robodebt scandal. Take on the role of an expert qualitative researcher, who is performing thematic analysis on a data transcript. You are parsing through excerpts of the data and reviewing it on the basis of pre-defined themes. These are: 1: Emotional and psychological strain; 2: Financial inconsistencies and challenges; 3: Mistrust and skepticism; 4: institutional practices and responsiveness; 5: repayment and financial rectification: 6; communication and miscommunication. For output, score how much each theme relates to the supplied statement, on a scale of 0.0 to 1.0, as tab-delimited output.  '
...
for i, prompt in enumerate(prompts):
    ...
    prompt = "Score the following statement for each of the six themes:\n\n" + prompt
