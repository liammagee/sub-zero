...
agreement_gpt4_4_llama2_count_1, agreement_gpt4_4_llama2_1 = calculate_agreement(gpt4_4_data_rounded_1, llama2_data_rounded_1)
...
agreement_gpt4_4_llama2_count_2, agreement_gpt4_4_llama2_2 = calculate_agreement(gpt4_4_data_rounded_2, llama2_data_rounded_2)
...
print(f'GPT-4-4 agreement with Llama2, threshold {threshold_1}:', agreement_gpt4_4_llama2_count_1, agreement_gpt4_4_llama2_1)
...
print(f'GPT-4-4 agreement with Llama2, threshold {threshold_2}:', agreement_gpt4_4_llama2_count_2, agreement_gpt4_4_llama2_2)
...
counts = pd.DataFrame({'Humans': count_humans, f'GPT-4, {threshold_1}': count_gpt4_1, f'GPT-4-04, {threshold_1}': count_gpt4_4_1, f'Llama2, {threshold_1}': count_llama2_1, f'GPT-4, {threshold_2}': count_gpt4_2, f'GPT-4-04, {threshold_2}': count_gpt4_4_2, f'Llama2, {threshold_2}': count_llama2_2})
...
full_counts = pd.DataFrame({'Humans': full_0, f'GPT-4': full_1, f'GPT-4-04': full_2, f'Llama2': full_3})
...
print("")
print("Correlations")
print(corr_humans_gpt4, corr_humans_gpt4_4, corr_humans_llama2, corr_gpt4_llama2)
print("")
...
print(corr_gpt4_llama2, p_gpt4_llama2)
print("")
...
print(jaccard_humans_gpt4, jaccard_humans_gpt4_4, jaccard_humans_llama2, jaccard_gpt4_llama2)
...
total_themes_gpt4_4_2 = gpt4_4_data_rounded_1.sum().sum()
total_themes_llama2_2 = llama2_data_rounded_1.sum().sum()

print("total themes applied")
print(total_themes_humans, total_themes_gpt4_1, total_themes_gpt4_4_1, total_themes_llama2_1, total_themes_gpt4_2, total_themes_gpt4_4_2, total_themes_llama2_2)
